<%-- 
    Document   : Frm_Proveedor
    Created on : 11 may. 2022, 15:22:52
    Author     : Telyman
--%>
                ...
                <div class="col-md-8 mx-auto">
                    ...
                    <%
                        ...
                        if (codigo > 0) {
                            ...
                            proveedor = logica.ObtenerRegistro("NUM_PROVEEDOR=" + id);
                        } else {
                            // Sino, crea uno nuevo
                    ...
                    <form action="CrearModificarProveedor" method="post" id="form_AgregarModificar">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="txtCodigo2" name="txtCodigo2" value="<%=proveedor.getNum_proveedor()%>" readonly class="form-control"/><br>
                            <%} else {%>
                        ...
                        <div class="form-group">
                            <label for="txtCodigo" class="control-label">N° Proveedor</label>
                            <input type="txt" id="txtCodigo" name="txtCodigo" value="<%=proveedor.getNum_proveedor()%>" class="form-control"/><br>
                        </div>

                        <!-- form-group para los controles de Nombre -->
                        <div class="form-group">
                            <label for="txtNombre" class="control-label">Nombre Organizacion</label>
                            <input type="txt" id="txtNombre" name="txtNombre" value="<%=proveedor.getNombre_org()%>" class="form-control"/><br>
                        </div>
                        
                        
                                   <!-- form-group para los controles de Dirección -->
                        <div class="form-group">
                            <label for="txtC" class="control-label">Correo</label>
                            <input type="txt" id="txtC" name="txtC" value="<%=proveedor.getCorreo()%>" class="form-control"/><br>
                        </div>

                        
                          <!-- form-group para los controles de Apellido -->
                        <div class="form-group">
                            <label for="txtD" class="control-label">Direccion</label>
                            <input type="txt" id="txtD" name="txtD" value="<%=proveedor.getDireccion()%>" class="form-control"/><br>
                        </div>
                        <!-- form-group para los controles de Teléfono -->
                        <div class="form-group">
                            <label for="txtTelefono" class="control-label">Telefono</label>
                            <input type="number" id="txtTelefono" name="txtTelefono" value="<%=proveedor.getTelefono()%>" class="form-control" placeholder="00-00-00-00"/><br>
                        </div>
