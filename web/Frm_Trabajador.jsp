<%-- 
    Document   : Frm_Trabajador
    Created on : 11 may. 2022, 14:29:02
    Author     : Telyman
--%>
                ...
                <div class="col-md-8 mx-auto">
                    ...
                    <%
                        ...
                        if (codigo > 0) {
                            ...
                            trabajador = logica.ObtenerRegistro("ID_Trabajador=" + id);
                        } else {
                            // Sino, crea uno nuevo
                    ...
                    <form action="CrearModificarTrabajador" method="post" id="form_AgregarModificar">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="txtCodigo2" name="txtCodigo2" value="<%=trabajador.getId_trabajador()%>"  class="form-control"/><br>
                            <%} else {%>
                            <!-- Sino, el campo ID se le asigna -1 y no se muestra en pantalla -->
                            <br>
                            <label for="txtCodigo2" class="control-label">Código</label>
                            <input type="number" id="txtCodigo2" name="txtCodigo2" readonly value="<%=trabajador.getId_trabajador()%>"/><br>
                            <%}%>
                        </div>
                        ...
                        <!--<div class="form-group">
                            <label for="txtCodigo" class="control-label">ID Trabajador</label>
                            <input type="txt" id="txtCodigo" name="txtCodigo" value="<%=trabajador.getId_trabajador()%>" class="form-control"/><br>
                        </div>-->

                        <!-- form-group para los controles de Nombre -->
                        <div class="form-group">
                            <label for="txtNombre" class="control-label">Nombre</label>
                            <input type="txt" id="txtNombre" name="txtNombre" value="<%=trabajador.getNombre()%>" class="form-control"/><br>
                        </div>
                        
                          <!-- form-group para los controles de Apellido -->
                        <div class="form-group">
                            <label for="txtApellidos" class="control-label">Apellidos</label>
                            <input type="txt" id="txtApellidos" name="txtApellidos" value="<%=trabajador.getApellidos()%>" class="form-control"/><br>
                        </div>
                        <!-- form-group para los controles de Teléfono -->
                        <div class="form-group">
                            <label for="txtTelefono" class="control-label">Teléfono</label>
                            <input type="txt" id="txtTelefono" name="txtTelefono" value="<%=trabajador.getTelefono()%>" class="form-control" placeholder="00-00-00-00"/><br>
                        </div>

                        <!-- form-group para los controles de Dirección -->
                        <div class="form-group">
                            <label for="txtDireccion" class="control-label">Residencia</label>
                            <input type="txt" id="txtDireccion" name="txtDireccion" value="<%=trabajador.getResidencia()%>" class="form-control"/><br>
                        </div>
