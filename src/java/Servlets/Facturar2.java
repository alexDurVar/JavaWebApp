 ...
 * @author Steven
 */
public class Facturar2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            int resultado;
            String mensaje= "";
            /*Lo que hace este servlet es primero se asegura que los datos para el encabezado de la factura no esten vacios o nulos y si es asi, los manda a guardar a la base de datos, de una sola vez, gurada tambien los daos de los detalles de la factura, (si tuviera), pone la factura en pentiente, aqui no se cancela ninguna factura*/
            ...
            if(request.getParameter("txtNombreCliente")!= null && 
                ...
                EntidadFactura.setSubtotal(Float.parseFloat(request.getParameter("txtSubt"))); 
                EntidadFactura.setFecha(fechasql);
                EntidadFactura.setId_cliente(Integer.parseInt(request.getParameter("txtIdCliente")));
                EntidadFactura.setEstado("Pendiente");
                if(!(request.getParameter("txtdescripcion").equals("")) && !(request.getParameter("txtcantidad").equals("")) && !(request.getParameter("txtprecio").equals(""))&& !(request.getParameter("txtdesc").equals(""))){
                    ...
                    EntidadDetalle.setDescuento(Float.parseFloat(request.getParameter("txtdesc"))); 
