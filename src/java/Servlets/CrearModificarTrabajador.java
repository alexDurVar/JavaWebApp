    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
         /* TODO output your page here. You may use following sample code. */
            ...
            trabajador.setId_trabajador(Integer.parseInt(request.getParameter("txtCodigo2")));
            ...
            trabajador.setApellidos(new String(request.getParameter("txtApellidos").getBytes("ISO-8859-1"), "UTF-8"));
            ...
            trabajador.setResidencia( new String(request.getParameter("txtDireccion").getBytes("ISO-8859-1"), "UTF-8"));
          ...
          if(Logica.Verificar_Insert(trabajador) ==1){ //Si existe lo modifica
              resultado = Logica.Modificar(trabajador);
          }else{
              resultado = Logica.Insertar(trabajador); //Si no existe lo ingresa
          }
           
            
            response.sendRedirect("FrmListarTrabajador.jsp");
